...
public class CDGStudy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<ExperimentProblem<DoubleSolution>> problemList = List.of(
                new ExperimentProblem<>(new Schaffer()),
                new ExperimentProblem<>(new Kursawe()),
                new ExperimentProblem<>(new Fonseca()),
        ...
        Experiment<DoubleSolution, List<DoubleSolution>> experiment =
                new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("CDGStudy")
